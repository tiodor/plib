#include <Plib-Generic/Alloc.hpp>

int main ( int argc, char * argv[] )
{
	Plib::Generic::MemoryMgr< sizeof(int), 32 > memMgr;
	//Plib::Generic::Alloc< int > alloc;
	Plib::Generic::Queue< int * > queue;
	std::string _cmd;
	
	while ( true )
	{
		std::cout << "memorymgr_ut: $> ";
